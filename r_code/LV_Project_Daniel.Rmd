...
```{r}
par(mfrow=c(1,5))
hist(data$ClaimNb, main = 'Original Dist. of #Claims', xlab = '#Claims')
hist(data$ClaimNb[!data$ClaimNb==0], main = '#Claims ( -0 )', xlab = '#Claims')
hist(data$ClaimNb[!(data$ClaimNb %in% c(0,1))], main = '#Claims ( -0,1 )', xlab = '#Claims')
hist(data$ClaimNb[!(data$ClaimNb %in% c(0,1,2))], main = '#Claims ( -0,1,2 )', xlab = '#Claims')
hist(data$ClaimNb[!(data$ClaimNb %in% c(0,1,2,3))],, main = '#Claims ( -0,1,2,3 )', xlab = '#Claims')
```
...
hist(x, main = paste("Dist. of Scaled NbClaims"), probability = TRUE, breaks = 50,xlab='Scaled NbClaims')

x <- nozeros[nozeros<50]
hist(x, main = paste("Dist. of Scaled NbClaims (0 removed)"), probability = TRUE, breaks = 50,xlab='Scaled NbClaims')
```
